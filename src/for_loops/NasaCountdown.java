 ...
 * 
 * But the lift off is only seconds away. Somebody has to do the countdown – or the rocket can’t start and
...
public class NasaCountdown {
	public static void main(String[] args) {
		...
		String lop=JOptionPane.showInputDialog("tell me when to start");
		// 3. convert the user's answer to an int (Integer.parseInt)
int lol=Integer.parseInt(lop);

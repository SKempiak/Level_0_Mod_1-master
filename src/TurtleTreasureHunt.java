...
if (tortoiseLocationX==505&&tortoiseLocationY==305) {
	JOptionPane.showMessageDialog(null, "go to the black thing in the middle of the scene.");
	Tortoise.explode();
}

			// 7. Give the user subsequent clues at different locations on the image
			// (pirate robot, swamp, parrots, etc.)
if (tortoiseLocationX==320&&tortoiseLocationY==145) {
	JOptionPane.showMessageDialog(null, "got to the bottle in the blue stuff");
}
if (tortoiseLocationX==295&&tortoiseLocationY==380) {
JOptionPane.showMessageDialog(null, "CONGRADULATIONS YOU FINISHED THE TREASURE HUNT");	
}			
		}		
